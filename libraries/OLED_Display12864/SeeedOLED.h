...
void setBitmapRect(unsigned char startPage, unsigned char endPage, unsigned char startColumn, unsigned char endColumn);
void clearDisplay();
void setBrightness(unsigned char Brightness);
void putChar(unsigned char c);
void putString(const char *String);
void putHZChar(unsigned char *hzData,int len);
...
void drawBitmap(unsigned char *bitmaparray,int bytes,bool usePgmspace);
...
void setVerticalScrollProperties(bool direction,unsigned char startPage, unsigned char endPage, unsigned char scrollSpeed,unsigned char verticalOffset);
void activateScroll();
